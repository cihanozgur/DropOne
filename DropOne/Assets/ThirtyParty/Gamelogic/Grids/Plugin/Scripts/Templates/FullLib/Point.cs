...
namespace Gamelogic.Grids
{
    public partial struct RectPoint
    {
        ...
        {
            bool areEqual = (x == other.X) && (z == other.Y);
            return areEqual;
        }
        ...
        {
            return new RectPoint(x + translation.X, z + translation.Y);
        }

        public RectPoint Negate()
        {
            return new RectPoint(-x, -z);
        }

        public RectPoint ScaleDown(int r)
        {
            return new RectPoint(GLMathf.FloorDiv(x, r), GLMathf.FloorDiv(z, r));
        }

        public RectPoint ScaleUp(int r)
        {
            return new RectPoint(x * r, z * r);
        }
        ...
        {
            return new RectPoint(x - other.X, z - other.Y);
        }
        ...
        {
            return x * other.X + z * other.Y;
        }

        [Version(1, 7)]
        public int PerpDot(RectPoint other)
        {
            return x * other.Y - z * other.x;
        }

        [Version(1, 10)]
        public RectPoint Perp()
        {
            return new RectPoint(-z, x);
        }
        ...
        public int GetColor(int ux, int vx, int vy)
        {
            ...
            float a = (x * vy - z * vx) / (float)colorCount;
            float b = (z * ux) / (float)colorCount;
